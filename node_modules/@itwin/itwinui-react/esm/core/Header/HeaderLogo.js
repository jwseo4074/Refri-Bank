 ...
 */
export var HeaderLogo = function (props) {
    var className = props.className, children = props.children, logo = props.logo, onClick = props.onClick, rest = __rest(props, ["className", "children", "logo", "onClick"]);
