...
export var SidenavButton = React.forwardRef(function (props, ref) {
    ...
    useTheme();
    return (React.createElement(Button, __assign({ className: cx('iui-sidenav-button', { 'iui-active': isActive }, className), size: 'large', disabled: disabled, ref: ref }, rest), children));
});
