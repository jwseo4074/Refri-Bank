 ...
 * </DropdownMenu>
 */
export var DropdownMenu = function (props) {
    ...
    var _c = React.useState(visible !== null && visible !== void 0 ? visible : false), isVisible = _c[0], setIsVisible = _c[1];
    React.useEffect(function () {
        setIsVisible(visible !== null && visible !== void 0 ? visible : false);
    }, [visible]);
    var open = React.useCallback(function () { return setIsVisible(true); }, []);
    ...
    useTheme();
    return (React.createElement(Popover, __assign({ content: React.createElement(Menu, { className: className, style: style, role: role, id: id }, React.useMemo(function () { return menuItems(close); }, [menuItems, close])), visible: trigger === undefined ? isVisible : undefined, onClickOutside: close, placement: placement, onShow: onShowHandler, onHide: onHideHandler, trigger: visible === undefined ? trigger : undefined }, rest), React.cloneElement(children, {
