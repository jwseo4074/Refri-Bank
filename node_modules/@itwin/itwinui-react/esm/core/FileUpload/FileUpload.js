...
export var FileUpload = React.forwardRef(function (props, ref) {
    ...
    useTheme();
    var _a = React.useState(false), isDragActive = _a[0], setIsDragActive = _a[1];
    var fileUploadRef = React.useRef(null);
    var refs = useMergedRefs(fileUploadRef, ref);
    ...
    return (React.createElement("div", __assign({ className: cx('iui-file-upload', { 'iui-drag': isDragActive }, className), onDragEnter: onDragEnterHandler, onDragOver: onDragOverHandler, onDragLeave: onDragLeaveHandler, onDrop: onDropHandler, ref: refs }, rest),
