...
export var IdeasButton = React.forwardRef(function (props, ref) {
    ...
    useTheme();
    return (React.createElement(Button, __assign({ ref: ref, className: 'iui-idea', onClick: onClick, startIcon: React.createElement(SvgSmileyHappy, { "aria-hidden": true }) }, rest), feedbackLabel));
});
