 ...
 * </Blockquote>
 */
export var Blockquote = React.forwardRef(function (props, ref) {
    var className = props.className, children = props.children, footer = props.footer, rest = __rest(props, ["className", "children", "footer"]);
    useTheme();
    return (React.createElement("blockquote", __assign({ className: cx('iui-blockquote', className), ref: ref }, rest),
        children,
