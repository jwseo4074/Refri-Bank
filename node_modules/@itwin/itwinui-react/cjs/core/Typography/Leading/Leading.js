...
exports.Leading = react_1.default.forwardRef(function (props, ref) {
    ...
    useTheme_1.useTheme();
    return (react_1.default.createElement("h3", __assign({ ref: ref, className: classnames_1.default('iui-text-leading', { 'iui-text-muted': isMuted }, className) }, rest)));
});
