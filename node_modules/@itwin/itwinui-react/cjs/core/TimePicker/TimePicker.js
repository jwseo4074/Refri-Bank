...
var TimePicker = function (props) {
    ...
    var hours = react_1.default.useMemo(function () {
    ...
    var minutes = react_1.default.useMemo(function () {
        var time = selectedTime !== null && selectedTime !== void 0 ? selectedTime : new Date();
    ...
    var seconds = react_1.default.useMemo(function () {
        var time = selectedTime !== null && selectedTime !== void 0 ? selectedTime : new Date();
        return generateDataList(60, function (i) {
    ...
    return (react_1.default.createElement("div", __assign({ className: (0, classnames_1.default)('iui-time-picker', className) }, rest),
        ...
        precision != 'hours' && (react_1.default.createElement(TimePickerColumn, { data: minutes, isSameFocused: function (val) { return isSameMinute(val, focusedTime); }, isSameSelected: function (val) { return isSameMinute(val, selectedTime); }, onFocusChange: function (date) { return setFocusedTime(date); }, onSelectChange: function (date) { return updateCurrentTime(date); }, valueRenderer: minuteRenderer })),
        precision == 'seconds' && (react_1.default.createElement(TimePickerColumn, { data: seconds, isSameFocused: function (val) { return isSameSecond(val, focusedTime); }, isSameSelected: function (val) { return isSameSecond(val, selectedTime); }, onFocusChange: function (date) { return setFocusedTime(date); }, onSelectChange: function (date) { return updateCurrentTime(date); }, valueRenderer: secondRenderer })),
        use12Hours && (react_1.default.createElement(TimePickerColumn, { data: ['AM', 'PM'], isSameFocused: function (val) { return isSameMeridiem(val, focusedTime); }, isSameSelected: function (val) { return isSameMeridiem(val, selectedTime); }, onFocusChange: function (date) { return onMeridiemFocus(date); }, onSelectChange: function (value) { return onMeridiemClick(value); }, valueRenderer: meridiemRenderer, className: 'iui-period' }))));
};
...
var TimePickerColumn = function (props) {
    ...
    return (react_1.default.createElement("div", { className: className },
        react_1.default.createElement("ol", null, data.map(function (value, index) {
