...
exports.useStyles = index_2.makeStyles(function (theme) { return ({
    root: {
...
exports.TableModule = React.memo(function (_a) {
    ...
    utils_1.warning(Boolean(onRowClick) &&
        !rowClickLabel &&
    ...
    return (React.createElement("table", __assign({ role: "table", className: clsx_1.default(classes.root, className) }, rootProps),
        React.createElement("thead", { className: classes.tableHeader },
            React.createElement("tr", __assign({ className: classes.tableRow, role: "row" }, getTestProps_1.getTestProps(exports.testIds.headerRow)), headings === null || headings === void 0 ? void 0 :
                headings.map(function (header, i) { return (React.createElement(TableHeaderCell_1.TableHeaderCell, __assign({ index: i, headingsCount: headings.length, key: i, header: header, isSorting: sort.sortKey === i, sortDirection: sort.sortDirection, onClick: handleSortColumnClick }, getTestProps_1.getTestProps(exports.testIds.headerCell)))); }),
        ...
        React.createElement("tbody", { role: "rowgroup" },
            !isLoading && data && data.length === 0 && (React.createElement("tr", __assign({ className: clsx_1.default(classes.tableRow, classes.tableDataRow), role: "row" }, getTestProps_1.getTestProps(exports.testIds.noResultsRow)),
            ...
            data.map(function (row, rowIndex) {
                return (React.createElement(TableModuleRow_1.TableModuleRow, { key: "tableRow-" + rowIndex, data: row, onRowClick: onRowClick, rowRole: rowRole, maxCellWidth: maxCellWidth, row: row, headingsLength: headings === null || headings === void 0 ? void 0 : headings.length, cells: cells, rowActions: rowActions, rowClickLabel: rowClickLabel }));
            }),
            isLoading && (React.createElement("tr", __assign({ className: classes.tableRow }, getTestProps_1.getTestProps(exports.testIds.isLoadingRow)),
