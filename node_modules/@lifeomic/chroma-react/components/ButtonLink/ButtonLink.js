...
exports.ButtonLink = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(LinkOrExternalLink_1.LinkOrExternalLink, __assign({ disabled: disabled, innerRef: ref, target: target, rel: rel, className: clsx_1.default(classes.root, (_b = {},
