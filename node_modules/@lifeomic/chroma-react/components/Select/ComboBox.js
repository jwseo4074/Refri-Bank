...
exports.ComboBox = function (_a) {
    ...
    var classes = Select_1.useStyles({});
    ...
    var uniqueId = React.useState(function () { return id || name || UniqueId_1.generateUniqueId('combobox-'); })[0];
    ...
    return (React.createElement("div", { className: clsx_1.default(classes.root, className) },
        ...
        React.createElement(Popover_1.PopoverDisclosure, __assign({ className: clsx_1.default(classes.button, classes.comboxBoxOverflow, hasError && classes.buttonError, fullWidth && classes.buttonFullWidth, (_b = {},
